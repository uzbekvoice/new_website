...
export async function getServerSideProps() {
  ...
  const res3 = await fetch('https://content.uzbekvoice.ai/items/partners');
  const res4 = await fetch('https://content.uzbekvoice.ai/items/team_members');
  const res5 = await fetch('https://content.uzbekvoice.ai/items/faq_translations');
  const res6 = await fetch('https://content.uzbekvoice.ai/items/contest_stages_translations');
