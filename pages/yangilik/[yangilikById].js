...
export async function getServerSideProps({ params }) {
  const res = await fetch(`https://content.uzbekvoice.ai/items/news_translations/?filter[news_id]=${params.yangilikById}`)
  const res2 = await fetch('https://content.uzbekvoice.ai/items/news_translations')
