...
export async function getServerSideProps() {
  ...
  const res3 = await fetch("http://localhost:8055/items/contest_stages_translations");
  const res4 = await fetch("http://localhost:8055/items/contest_gifts_translations");
