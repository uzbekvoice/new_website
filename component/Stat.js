    ...
    <div className={styles.statistic}>
        <div className={styles.content}>
         ...
         <div className={styles.img_top}>
           <Image src='/stat-top.png'  width={308} height={17} alt="stat" />
         </div>
         <div className={styles.img_bottom}>
           <Image src='/stat-bottom.png'  width={1268} height={251} alt="stat" />
         </div>
         <div className={styles.img_hour}>
           <Image src='/stat-hour.jpg'  width={1052} height={389} alt="stat" />
         </div>
    </div>
